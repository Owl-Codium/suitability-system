...
document.addEventListener("DOMContentLoaded", function () {
    ...
    function determineProfile(points) {
        let profileText = '<p class="profile-text">Seu perfil é</p>';
        if (points <= 110) {
            profileText+= '<p style="font-size: 25px; font-weight: bolder; text-decoration: underline; font-family: \'Vonique 43\', sans-serif;">Super Conservador</p>';
            profileText+= '<p style="text-align:justify">É composto por ativos com baixo risco com foco na preservação de capital. É recomendado para os participantes que possuem aversão a riscos e que estejam próximos à aposentadoria ou já em recebimento de benefício. No Ciclo de Vida, estão enquadradas neste perfil as pessoas acima de 60 anos de idade.</style=>';
            profileText+= '<p style="text-align:justify">A Néos também oferece o perfil de Ciclo de Vida, composto pelos perfis Super Conservador, Conservador, Moderado e Agressivo. Nesta opção, a mudança do perfil fica condicionada a Fase de vida do participante, ou seja, conforme a idade do participante será definido o perfil de investimentos mais adequado de acordo com o ciclo de vida. Cabe ressaltar que o Participante/Assistido que optar pelo Ciclo de Vida autoriza a Entidade a ajustar o seu perfil de acordo com a sua idade e ciclo de vida.</p>';
            profileText+= '<p style="text-align:justify">Na Néos, a mudança do seu Perfil de Investimento é permitida a qualquer tempo, desde que respeitado o intervalo de 6 meses entre elas.</p>';
        } else if (points <= 210) {
            profileText+= '<p style="font-size: 25px; font-weight: bolder; text-decoration: underline; font-family: \'Vonique 43\', sans-serif;">Conservador:</p>';
            profileText+= '<p style="text-align:justify">Sua composição apresenta um grau de risco um pouco superior ao Superconservador. O foco é a preservação de capital, porém com uma relação risco x retorno entre superconservador e moderado. Tem 90% de seus recursos alocados em ativos defensivos, tais como: renda fixa, renda fixa no exterior, multimercados com baixa volatilidade. E os 10% restantes alocados em ativos dinâmicos, tais como: FIP, imobiliários, multimercado estruturados, renda variável local e no exterior. Recomendado para aqueles participantes que aceitam correr um pouco mais de risco para ter um retorno melhor que o taxa de juros livre de risco ou/e que estão se aproximando da idade para se aposentar. No Ciclo de Vida, estão enquadradas neste perfil as pessoas até 60 anos de idade.</p>';
            profileText+= '<p style="text-align:justify">A Néos também oferece o perfil de Ciclo de Vida, composto pelos perfis Super Conservador, Conservador, Moderado e Agressivo. Nesta opção, a mudança do perfil fica condicionada a Fase de vida do participante, ou seja, conforme a idade do participante será definido o perfil de investimentos mais adequado de acordo com o ciclo de vida. Cabe ressaltar que o Participante/Assistido que optar pelo Ciclo de Vida autoriza a Entidade a ajustar o seu perfil de acordo com a sua idade e ciclo de vida.</p>';
            profileText+= '<p style="text-align:justify">Na Néos, a mudança do seu Perfil de Investimento é permitida a qualquer tempo, desde que respeitado o intervalo de 6 meses entre elas.</p>';
        } else if (points <= 310) {
            profileText+= '<p style="font-size: 25px; font-weight: bolder; text-decoration: underline; font-family: \'Vonique 43\', sans-serif;">Moderado:</p>';
            profileText+= '<p style="text-align:justify">Sua composição apresenta uma relação risco x retorno moderada. O foco é preservação e acumulação de capital. Tem 70% de seus recursos alocada em ativos defensivos, tais como: renda fixa, renda fixa no exterior, multimercados com baixa volatilidade. E os 30% restantes alocados em ativos dinâmicos, tais como: FIP, imobiliários, multimercado estruturados, renda variável local e no exterior. Recomendado para aqueles participantes ou assistido que aceitam correr mais de risco para ter um retorno melhor que o taxa de juros livre de risco. No Ciclo de Vida, estão enquadradas neste perfil as pessoas até 50 anos de idade.</p>';
            profileText+= '<p style="text-align:justify">A Néos também oferece o perfil de Ciclo de Vida, composto pelos perfis Super Conservador, Conservador, Moderado e Agressivo. Nesta opção, a mudança do perfil fica condicionada a Fase de vida do participante, ou seja, conforme a idade do participante será definido o perfil de investimentos mais adequado de acordo com o ciclo de vida. Cabe ressaltar que o Participante/Assistido que optar pelo Ciclo de Vida autoriza a Entidade a ajustar o seu perfil de acordo com a sua idade e ciclo de vida.</p>';
            profileText+= '<p style="text-align:justify">Na Néos, a mudança do seu Perfil de Investimento é permitida a qualquer tempo, desde que respeitado o intervalo de 6 meses entre elas.</p>';
        } else {
            profileText+= '<p style="font-size: 25px; font-weight: bolder; text-decoration: underline; font-family: \'Vonique 43\', sans-serif;">Agressivo:</p>';
            profileText+= '<p style="text-align:justify">Sua composição apresenta uma relação risco x retorno mais arrojada. O foco é a acumulação de capital. Tem 50% de seus recursos alocados em ativos defensivos, tais como: renda fixa, renda fixa no exterior, multimercados com baixa volatilidade. E os 50% restantes alocados em ativos dinâmicos, tais como: FIP, imobiliários, multimercado estruturados, renda variável local e no exterior. Recomendado para aqueles participantes ou assistidos que são tolerantes ao risco e aceitam correr risco em busca de maiores retornos. No Ciclo de Vida, estão enquadradas neste perfil as pessoas até 50 anos de idade.</p>';
            profileText+= '<p style="text-align:justify">A Néos também oferece o perfil de Ciclo de Vida, composto pelos perfis Super Conservador, Conservador, Moderado e Agressivo. Nesta opção, a mudança do perfil fica condicionada a Fase de vida do participante, ou seja, conforme a idade do participante será definido o perfil de investimentos mais adequado de acordo com o ciclo de vida. Cabe ressaltar que o Participante/Assistido que optar pelo Ciclo de Vida autoriza a Entidade a ajustar o seu perfil de acordo com a sua idade e ciclo de vida.</p>';
            profileText+= '<p style="text-align:justify">Na Néos, a mudança do seu Perfil de Investimento é permitida a qualquer tempo, desde que respeitado o intervalo de 6 meses entre elas.</p>';
        }
