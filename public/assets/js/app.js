...
document.addEventListener("DOMContentLoaded", function () {
    ...
    function determineProfile(points) {
        ...
        if (points <= 110) {
            profileText+= '<p style="font-size: 35px; font-weight: bolder; text-decoration: underline; font-family: \'Vonique 43\', sans-serif;">Super Conservador</p>';
            ...
            profileText+= '<p style="font-size: 35px; font-weight: bolder; text-decoration: underline; font-family: \'Vonique 43\', sans-serif;">Conservador:</p>';
            ...
            profileText+= '<p style="font-size: 35px; font-weight: bolder; text-decoration: underline; font-family: \'Vonique 43\', sans-serif;">Moderado:</p>';
            ...
            profileText+= '<p style="font-size: 35px; font-weight: bolder; text-decoration: underline; font-family: \'Vonique 43\', sans-serif;">Agressivo:</p>';
